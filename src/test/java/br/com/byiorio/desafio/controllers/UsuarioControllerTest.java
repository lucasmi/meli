...
class UsuarioControllerTest {
        ...
        void putErrorTest() throws Exception {
                ...
                // e executa o post
                String request = FileUtils.readFileToString(
                                ResourceUtils.getFile("classpath:./usuario/PutRequestError1.json"),
                                StandardCharsets.UTF_8.name());

                // Consulta o usuario criado
                mvc.perform(MockMvcRequestBuilders.put("/usuarios/99d44695-2b71-451a-97ee-1398a0ssa5")
                                .content(request)
                                .contentType(MediaType.APPLICATION_JSON))
                                .andDo(MockMvcResultHandlers.print())
                                .andExpect(MockMvcResultMatchers.status().is4xxClientError())
                                .andExpect(MockMvcResultMatchers.jsonPath("$.errors[0].msg",
                                                Matchers.containsString("nao encontrado na base usuarios")));
        }
        ...
        void postMeioPagamentoTest() throws Exception {
                ...
                // Insere meio de pagamento no usuario
        ...
        void putMeioPagamentoTest() throws Exception {
                ...
                // Atualiza meio de pagamento do usuario
